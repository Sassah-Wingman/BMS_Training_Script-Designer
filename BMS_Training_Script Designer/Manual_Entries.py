...
def manual_comment(function):
    if function == "-COMMENT-":
        ...
        to another screen location by using either SetCorsor or MoveCursor.""",
                        title = "BMS Techincal Manual Chapter 14.5.1", image = Script_Images.movecursor_image, size = (100,10), button_justification = "c", modal = True, keep_on_top = True)
    elif function == "-COLOR-":
        sg.popup_scrolled("""
                        Function: SetColor
                        Syntax: SetColor <hex> 
        ...
        another value is defined either using SetColor, SetFontColor or SetDrawColor.  """,
            ...
            affects all following print functions until another value is defined. """,
                        title = "BMS Techincal Manual Chapter 14.5.3", image = Script_Images.justification_image, button_justification = "c", size = (100,10), modal = True, keep_on_top = True)
    elif function == "-LINEW-":
            sg.popup_scrolled("""
            ...
            This setting is used for all following draw functions until another value is defined. """,
                        title = "BMS Techincal Manual Chapter 14.5.3", image = Script_Images.width_image, button_justification = "c", size = (100,10), modal = True, keep_on_top = True)
    elif function == "-LINE-":
            sg.popup_scrolled("""
                        Function: Line 
            ...
            center. """,
                        title = "BMS Techincal Manual Chapter 14.5.3", image = Script_Images.oval_image, button_justification = "c", size = (100,10), modal = True, keep_on_top = True)
    elif function == "-PRINT-":
                sg.popup_scrolled("""
                        Function: Print
            ...
            (0.0 0.0). Instead of writing 0.0 you can also write just 0. """,
                            title = "BMS Techincal Manual Chapter 14.3", image = Script_Images.coordinate_image, size = (110,20), button_justification = "c", modal = True, keep_on_top = True)
    elif function == "-argm-":
            sg.popup_scrolled("""
